        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Data Variabel</div>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="float-right">
                                    <form method="GET" action="{{ route('variabel.index') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content">
                                                        ...
                                                        {{-- <a href='{{ route('variabel.edit', $variabel->id) }}'
                                                            class="btn btn-sm btn-info btn-icon ml-2">
                                                            <i class="fas fa-edit"></i>
                                                            Edit
                                                        </a> --}}

                                                        {{-- <form action="{{ route('variabel.destroy', $variabel->id) }}"
                                ...
                                <div class="float-right">
                                    {{ $variabels->withQueryString()->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
